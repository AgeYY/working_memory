...
def get_default_hp(rule_name, random_seed=None):
    ...
    hp = {
        ...
        # if cost_lsq is smaller than stop cost, stop training
        'stop_cost': 9999999, # we don't set requirement to the stop cost
        'stop_noise_cost': 1,
        'stop_color_error': 2, # both stop conditions must be meet
        ...
        'stop_delta_color_error': 10, # stopping ceriteria for delta training
